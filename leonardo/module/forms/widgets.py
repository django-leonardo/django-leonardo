...
__all__ = (
    ...
    'SplitHiddenDateTimeWidget', 'MultipleHiddenInput', 'SplitDateWidget'
)
...
class Input(forms.TextInput):
    input_type = None
    template_name = 'forms/widget/input.html'
    is_required = False
...
class Textarea(Input):
    template_name = 'forms/widget/textarea.html'
    rows = 10
    cols = 40
...
class TinyMceEditor(Textarea):
    template_name = 'forms/widget/tinymce.html'
...
if VERSION >= (1, 3):
    class ClearableFileInput(FileInput, forms.ClearableFileInput):
        template_name = 'forms/widget/clearable_input.html'
...
class Select(forms.Select, Input):
    template_name = 'forms/widget/select.html'
...
class CheckboxSelectMultiple(SelectMultiple):
    template_name = 'forms/widget/checkbox_select.html'


class RadioSelect(forms.RadioSelect, Select):
    template_name = 'forms/widget/radio.html'
...
class SplitDateWidget(forms.MultiWidget):
    def __init__(self,attrs=None,show_labels=False,year_range=None,month_range=None,day_range=None):
        YEARS = year_range or range(2011,2031)
