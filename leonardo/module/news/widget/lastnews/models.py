...
class LastNewsWidget(Widget):
    news_count = models.PositiveIntegerField(verbose_name=_("news count"), default=2)
    show_archive_button = models.BooleanField(default=True, verbose_name=_("show archive button"))
