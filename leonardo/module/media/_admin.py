...
from filer.admin.forms import (CopyFilesAndFoldersForm, RenameFilesForm,
                               ResizeImagesForm)
from filer.admin.patched.admin_utils import get_deleted_objects
from filer.admin.permissions import PrimitivePermissionAwareModelAdmin
from filer.admin.tools import (check_files_edit_permissions,
...
from filer.views import (popup_param, popup_status, selectfolder_param,
                         selectfolder_status)
...
class FileAdmin(FilerFileAdmin):
...
class FileFullAdmin(ModelAdmin):
    pass
...
class MyFolderAdmin(tree_editor.TreeEditor, PrimitivePermissionAwareModelAdmin):
    list_display = ('name',)
    #exclude = ('parent',)
    list_per_page = 20
    list_filter = ('owner',)
    ...
    def __init__(self, *args, **kwargs):
        super(MyFolderAdmin, self).__init__(*args, **kwargs)
    ...
    def get_form(self, request, obj=None, **kwargs):
        ...
        if parent_id:
            ...
            folder_form = super(MyFolderAdmin, self).get_form(
    ...
    def response_change(self, request, obj):
        ...
        """
        r = super(MyFolderAdmin, self).response_change(request, obj)
    ...
    def render_change_form(self, request, context, add=False, change=False,
        ...
        return super(MyFolderAdmin, self).render_change_form(
    ...
    def delete_view(self, request, object_id, extra_context=None):
        ...
        r = super(MyFolderAdmin, self).delete_view(
    ...
    def get_actions(self, request):
        actions = super(MyFolderAdmin, self).get_actions(request)
