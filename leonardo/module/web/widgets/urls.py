...
urlpatterns = patterns('',
                       url(r'^(?P<page_id>[\w\.\-]+)/(?P<cls_name>[\w\.\-]+)/select-widget/$',
                           WidgetPreCreateView.as_view(), name='widget_create_without_region'),
                       ...
                       url(r'^(?P<cls_name>[\w\.\-]+)/(?P<id>[\w\.\-]+)/move/$',
                           WidgetMoveView.as_view(), name='widget_move'),
                       url(r'^(?P<cls_name>[\w\.\-]+)/(?P<id>[\w\.\-]+)/copy/$',
                           WidgetCopyView.as_view(), name='widget_copy'),
